...
% Compute test values
[yout, tout, ydotout] = runge_kutta(ydot, y0, tlims, h);
...
% Compute test values
[yout, tout] = runge_kutta(ydot, y0, tlims, h, 3);
...
% Compute test values
[yout, tout] = runge_kutta(ydot, y0, tlims, h, 2);
...
% Compute test values
[yout, tout] = runge_kutta(ydot, y0, tlims, h, 1);
...
% Compute test values
[yout, tout] = runge_kutta(ydot, y0, tlims, h, ...
    4, cvec, amat, bvec);
...
% Compute test values
[yout6, tout] = runge_kutta(ydot, y0, tlims, h, 6);
